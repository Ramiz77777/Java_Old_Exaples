...
public class GorodaGiganti {
    ...
    public static void printCityPopulation(String city, double population){
        ...
        System.out.println("В то время как в самом густонаселенном городе " + GorodaGiganti.city + " население составляет " + GorodaGiganti.population + " млн человек.");
    }
        }
